...
## Inferential Results
graph Facstaats visually shows the overal line and skills the players did. Letting one  make the conclusion that skilled players do more push-ups than line players because it shows that skilled players did (number of pushups) while line players only did (number of pushups) 
